...
import { View, TouchableOpacity, StyleSheet, Text, ScrollView, Image, Alert } from 'react-native';
...
const Points = () => {
  ...
  useEffect(() => {
    ...
    async function loadPosition(){
      ...
      if(status !== 'granted'){
        Alert.alert('Ooops.', 'Precisamos de sua permissão para acessar sua localização.');
        return;
      }
